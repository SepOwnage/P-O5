...
\mytodo{In MATLAB regel aanpassen}
In MATLAB, the whole .wav-file is loaded at the start, whereas in C, the .wav-file is loaded buffer per buffer.
...
The subband filtering and synthesis functions require previous samples to do the convolution. The quantization and dequantization functions require previous samples to calculate the moving average. To do this, both functions keep a structure that contain previous samples.
