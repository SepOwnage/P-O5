...
The structure of the C/DSP code is the same as the MATLAB structure. The .c-files are largely the same as the MATLAB files. A difference is that for the DSP version, we use \texttt{quantizeTogether} and \texttt{dequantizeTogether} instead of texttt{quantize} and texttt{dequantize}, because this is more efficient.
