...
The encoding parameters $\mu$, $\phi$, buffer\_length and the number of bits can be different for each subband. The values for all these parameters are listed in tables \ref{tab:parametervalues} and \ref{tab:scalingparameters}.
